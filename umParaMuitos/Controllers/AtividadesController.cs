...
namespace umParaMuitos.Controllers
{
    public class AtividadesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AtividadeID,Titulo,DataInicio,Final,Descricao,Local,PessoaID")] Atividade atividade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AtividadeID,Titulo,DataInicio,Final,Descricao,Local,PessoaID")] Atividade atividade)
        {
            if (ModelState.IsValid)
            {
